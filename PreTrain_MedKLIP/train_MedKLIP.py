...
def main(args, config):
    ...
    train_datasets = MedKLIP_Dataset(config['train_file'],config['label_file'], config, mode = 'train')
    ...
    val_datasets = MedKLIP_Dataset(config['valid_file'],config['label_file'], config,mode ='train')
